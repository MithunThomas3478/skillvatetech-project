                ...
                <div className="container">
                    ...
                    <div className="board-grid">
                        <div className="member-card">
                            ...
                            <div className="member-social"><a href="#" target="_blank" aria-label="LinkedIn Profile"><i className="fab fa-linkedin-in"></i></a></div>
                        </div>
                        <div className="member-card">
            ...
            <section id="cta" className="section cta">
                <div className="container cta-content">
                    ...
                    <div className="cta-actions">
                        <Link to="/programs" className="btn btn-primary"><i className="fas fa-graduation-cap"></i> Explore Programs</Link>
                        <Link to="/contact" className="btn btn-secondary"><i className="fas fa-phone"></i> Contact Advisors</Link>
                    </div>
                </div>
            </section>
        </>
