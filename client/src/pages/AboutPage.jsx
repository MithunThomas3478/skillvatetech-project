        ...
        <section id="about-hero" className="hero">
          ...
          <div className="container hero-content">
            ...
            <div className="hero-actions">
              <a href="#team" className="btn btn-primary"><span>Meet the Team</span> <i className="fas fa-users"></i></a>
        ...
        <section id="vision-mission" className="section">
            <div className="container">
                ...
                <div className="grid-layout">
                    ...
                    <div className="styled-card">
                        <div className="card-header">
                            <div className="card-icon"><i className="fas fa-bridge"></i></div>
                    ...
                    <div className="styled-card">
                        ...
                        <p className="advantage-p" style={{marginTop: "1rem"}}><strong>Cutting-Edge Technical Expertise:</strong> We teach the latest industry-relevant technologies companies are actively hiring for.</p>
                        <p className="advantage-p" style={{marginTop: "1rem"}}><strong>Essential Professional Acumen:</strong> We cultivate the communication, teamwork, and leadership skills crucial for a successful career.</p>
                    </div>
                </div>
            ...
            <div className="container">
                ...
                <div className="infra-grid">
                    <div className="feature-card">
                        <div className="feature-icon"><i className="fas fa-flask-vial"></i></div><h4>Advanced Simulation Labs</h4>
                        <p>Equipped with industry-grade simulation tools, robotics arms, PLC stations, and IoT development kits.</p>
                    </div>
                    <div className="feature-card">
                        <div className="feature-icon"><i className="fas fa-users-gear"></i></div><h4>Collaborative Open Classrooms</h4>
                        <p>Dynamic learning spaces that reject traditional rows in favor of project-based teamwork and mentor interaction.</p>
                    </div>
                    <div className="feature-card">
                        <div className="feature-icon"><i className="fas fa-tools"></i></div><h4>Industry-Grade Equipment</h4>
        ...
        <section id="cta" className="section cta">
            <div className="container cta-content">
                ...
                <div className="cta-actions">
                    <Link to="/admission" className="btn btn-primary"><i className="fas fa-user-check"></i> Apply Now</Link>
                    <Link to="/contact" className="btn btn-secondary"><i className="fas fa-info-circle"></i> Request Info</Link>
                </div>
            </div>
        </section>
      </>
